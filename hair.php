...
<head>
    ...
    <title>Продукты для волос</title>
    <style>
    /* Основные стили */
<style>
        /* Основные стили */
...
<body>
   ...
   <main class="main">
    <div class="products">
        <?php
        // Получаем товары для категории "hair" из базы данных
        $category = 'hair';
    ...
    ?>тг.
        ...
        <?php
            ...
            echo '<p style="text-align: center; grid-column: 1 / -1; font-size: 18px; color: #666;">Товары для ухода за волосами не найдены</p>';
