...
<head>
    ...
    <title>Продукты для ухода за лицом</title>
    <style>
     /* Основные стили */
body, article, header {
    text-align: center;
...
<body>
   ...
   <main class="main">
    <div class="products">
        <?php
        // Получаем товары для категории "face" из базы данных
        $category = 'face';
    ...
    ?>тг.
        ...
        <?php
            ...
            echo '<p style="text-align: center; grid-column: 1 / -1; font-size: 18px; color: #666;">Товары для ухода за лицом не найдены</p>';
